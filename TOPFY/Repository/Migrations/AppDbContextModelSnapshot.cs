...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DomainModels.Models.UserConnection", b =>
                {
                    ...
                    b.Property<string>("FollowerIdId")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("DomainModels.Models.Tag", b =>
                {
                    b.HasOne("DomainModels.Models.Tag", "ParentTag")
                        .WithMany()
            ...
            modelBuilder.Entity("DomainModels.Models.UserConnection", b =>
                {
                    b.HasOne("DomainModels.Models.User", "FollowerId")
                        .WithMany()
            ...
            modelBuilder.Entity("PostTag", b =>
                {
                    b.HasOne("DomainModels.Models.Post", null)
                        .WithMany()
                        .HasForeignKey("PostsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DomainModels.Models.Tag", null)
                        .WithMany()
                        .HasForeignKey("SpecificTagsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
